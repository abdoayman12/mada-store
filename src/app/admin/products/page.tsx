...
export default function AdminProductsPage() {
    ...
    async function confirmDelete(id: string) {
        try {
            ...
            const productFilter = products?.filter((item) => item.id !== id);
                    ...
                    <div className="w-full max-w-sm rounded-3xl bg-white p-7 shadow-lift">
                        ...
                        <div className="mt-6 flex gap-3">
                            <button
                                ...
                                className={`flex-1 rounded-full bg-red-500 py-2.5 text-sm font-bold text-white transition hover:bg-red-600 ${deleteId ? "" : "pointer-events-none"}`}
                            >
                                حذف
                            </button>
                            <button
